...
SIGNAL \ESTADO_ATUAL.OPC~clkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \ESTADO_ATUAL.OPC~clkctrl_outclk\ : std_logic;
...
\ESTADO_ATUAL.OPC~clkctrl_INCLK_bus\ <= (gnd & gnd & gnd & \ESTADO_ATUAL.OPC~regout\);

\CLOCK~clkctrl_INCLK_bus\ <= (gnd & gnd & gnd & \CLOCK~combout\);

\Selector1~0clkctrl_INCLK_bus\ <= (gnd & gnd & gnd & \Selector1~0_combout\);

\Selector41~0clkctrl_INCLK_bus\ <= (gnd & gnd & gnd & \Selector41~0_combout\);
...
-- Equation(s):
-- \Add0~0_combout\ = (\VALOR~combout\(0) & (SALDO_CLIENTE(0) $ (VCC))) # (!\VALOR~combout\(0) & (SALDO_CLIENTE(0) & VCC))
-- \Add0~1\ = CARRY((\VALOR~combout\(0) & SALDO_CLIENTE(0)))
...
-- Equation(s):
-- \Add0~6_combout\ = (\VALOR~combout\(3) & ((SALDO_CLIENTE(3) & (\Add0~5\ & VCC)) # (!SALDO_CLIENTE(3) & (!\Add0~5\)))) # (!\VALOR~combout\(3) & ((SALDO_CLIENTE(3) & (!\Add0~5\)) # (!SALDO_CLIENTE(3) & ((\Add0~5\) # (GND)))))
-- \Add0~7\ = CARRY((\VALOR~combout\(3) & (!SALDO_CLIENTE(3) & !\Add0~5\)) # (!\VALOR~combout\(3) & ((!\Add0~5\) # (!SALDO_CLIENTE(3)))))
...
-- Equation(s):
-- \Add1~18_combout\ = ((\VALOR~combout\(6) $ (SALDO_CLIENTE(6) $ (\Add1~16\)))) # (GND)
-- \Add1~19\ = CARRY((\VALOR~combout\(6) & (SALDO_CLIENTE(6) & !\Add1~16\)) # (!\VALOR~combout\(6) & ((SALDO_CLIENTE(6)) # (!\Add1~16\))))
...
-- Equation(s):
-- S3(0) = (GLOBAL(\Selector41~0clkctrl_outclk\) & (\Selector49~0_combout\)) # (!GLOBAL(\Selector41~0clkctrl_outclk\) & ((S3(0))))
...
-- Equation(s):
-- S3(2) = (GLOBAL(\Selector41~0clkctrl_outclk\) & (\Selector52~0_combout\)) # (!GLOBAL(\Selector41~0clkctrl_outclk\) & ((S3(2))))
...
-- Equation(s):
-- S3(4) = (GLOBAL(\Selector41~0clkctrl_outclk\) & (\Selector54~0_combout\)) # (!GLOBAL(\Selector41~0clkctrl_outclk\) & ((S3(4))))
...
-- Equation(s):
-- S3(7) = (GLOBAL(\Selector41~0clkctrl_outclk\) & ((\Selector57~0_combout\))) # (!GLOBAL(\Selector41~0clkctrl_outclk\) & (S3(7)))
...
-- Equation(s):
-- \Equal0~0_combout\ = (!\ID~combout\(0) & (!\ID~combout\(2) & !\ID~combout\(1)))
...
-- Equation(s):
-- \Selector1~1_combout\ = (\OP_CODE~combout\ & ((\ESTADO_ATUAL.FU~regout\) # ((\ESTADO_ATUAL.OPD~regout\ & \Equal0~0_combout\)))) # (!\OP_CODE~combout\ & (((\ESTADO_ATUAL.OPD~regout\ & \Equal0~0_combout\))))
...
-- Equation(s):
-- \Selector3~4_combout\ = (!\Equal0~0_combout\ & ((\ESTADO_ATUAL.OPD~regout\) # (\ESTADO_ATUAL.OPC~regout\)))
...
-- Equation(s):
-- \PROXIMO_ESTADO.FU~0_combout\ = (!\ESTADO_ATUAL.S~regout\ & ((\ID~combout\(1)) # ((\ID~combout\(2)) # (\ID~combout\(0)))))
...
PORT MAP (
	clk => \CLOCK~combout\,
	sdata => \PROXIMO_ESTADO.FU~0_combout\,
	aclr => \RESET~clkctrl_outclk\,
	sload => VCC,
	ena => \ENABLE~combout\,
	devclrn => ww_devclrn,
...
-- Equation(s):
-- \Selector2~0_combout\ = (\Equal0~0_combout\ & ((\ESTADO_ATUAL.OPC~regout\) # ((\ESTADO_ATUAL.FU~regout\ & !\OP_CODE~combout\)))) # (!\Equal0~0_combout\ & (\ESTADO_ATUAL.FU~regout\ & ((!\OP_CODE~combout\))))
...
-- Location: CLKCTRL_G8
\ESTADO_ATUAL.OPC~clkctrl\ : cycloneii_clkctrl
-- pragma translate_off
GENERIC MAP (
	clock_type => "global clock",
	ena_register_mode => "none")
-- pragma translate_on
PORT MAP (
	inclk => \ESTADO_ATUAL.OPC~clkctrl_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \ESTADO_ATUAL.OPC~clkctrl_outclk\);
...
-- Equation(s):
-- \Selector41~0_combout\ = (!\ID~combout\(2) & (\ID~combout\(1) & (\ID~combout\(0) & \WideOr3~0_combout\)))
...
\Selector41~0clkctrl\ : cycloneii_clkctrl
-- pragma translate_off
GENERIC MAP (
	clock_type => "global clock",
	ena_register_mode => "none")
...
-- Equation(s):
-- S3(1) = (GLOBAL(\Selector41~0clkctrl_outclk\) & (\Selector51~0_combout\)) # (!GLOBAL(\Selector41~0clkctrl_outclk\) & ((S3(1))))
...
-- Equation(s):
-- \Add1~0_combout\ = (SALDO_CLIENTE(0) & ((GND) # (!\VALOR~combout\(0)))) # (!SALDO_CLIENTE(0) & (\VALOR~combout\(0) $ (GND)))
...
-- Equation(s):
-- \Add1~3_combout\ = (SALDO_CLIENTE(1) & ((\VALOR~combout\(1) & (!\Add1~1\)) # (!\VALOR~combout\(1) & (\Add1~1\ & VCC)))) # (!SALDO_CLIENTE(1) & ((\VALOR~combout\(1) & ((\Add1~1\) # (GND))) # (!\VALOR~combout\(1) & (!\Add1~1\))))
-- \Add1~4\ = CARRY((SALDO_CLIENTE(1) & (\VALOR~combout\(1) & !\Add1~1\)) # (!SALDO_CLIENTE(1) & ((\VALOR~combout\(1)) # (!\Add1~1\))))
...
-- Equation(s):
-- \Mux4~0_combout\ = (!\ID~combout\(2) & \ID~combout\(1))
...
-- Equation(s):
-- \Selector50~0_combout\ = (\ID~combout\(1) & (!\ID~combout\(2) & (\WideOr3~0_combout\ & !\ID~combout\(0))))
...
-- Equation(s):
-- \Selector23~0_combout\ = (\WideOr3~0_combout\ & (\ID~combout\(2) & (!\ID~combout\(1) & \ID~combout\(0))))
...
-- Equation(s):
-- S3(3) = (GLOBAL(\Selector41~0clkctrl_outclk\) & (\Selector53~0_combout\)) # (!GLOBAL(\Selector41~0clkctrl_outclk\) & ((S3(3))))
...
-- Equation(s):
-- \Add1~6_combout\ = ((\VALOR~combout\(2) $ (SALDO_CLIENTE(2) $ (\Add1~4\)))) # (GND)
-- \Add1~7\ = CARRY((\VALOR~combout\(2) & (SALDO_CLIENTE(2) & !\Add1~4\)) # (!\VALOR~combout\(2) & ((SALDO_CLIENTE(2)) # (!\Add1~4\))))
...
-- Equation(s):
-- \Selector1~0_combout\ = (\OP_CODE~combout\ & \ESTADO_ATUAL.FU~regout\)
...
-- Equation(s):
-- RESULT_SUM(0) = (GLOBAL(\Selector1~0clkctrl_outclk\) & (\Add0~0_combout\)) # (!GLOBAL(\Selector1~0clkctrl_outclk\) & ((RESULT_SUM(0))))
...
-- Equation(s):
-- \Selector59~0_combout\ = (!\ID~combout\(1) & (!\ID~combout\(2) & (\WideOr3~0_combout\ & \ID~combout\(0))))
...
-- Equation(s):
-- \Selector14~0_combout\ = (\ID~combout\(1) & (\WideOr3~0_combout\ & (\ID~combout\(2) & !\ID~combout\(0))))
...
-- Equation(s):
-- \Selector32~0_combout\ = (!\ID~combout\(1) & (\WideOr3~0_combout\ & (\ID~combout\(2) & !\ID~combout\(0))))
...
-- Equation(s):
-- \Mux7~0_combout\ = (\ID~combout\(1) & (\ID~combout\(0))) # (!\ID~combout\(1) & ((\ID~combout\(0) & ((S5(0)))) # (!\ID~combout\(0) & (S4(0)))))
...
-- Equation(s):
-- \Selector5~0_combout\ = (\ID~combout\(1) & (\ID~combout\(2) & (\WideOr3~0_combout\ & \ID~combout\(0))))
...
-- Equation(s):
-- \Mux7~2_combout\ = (\Mux4~2_combout\ & (((\Mux7~1_combout\)) # (!\Mux4~1_combout\))) # (!\Mux4~2_combout\ & (\Mux4~1_combout\ & (S1(0))))
...
-- Equation(s):
-- \Add0~2_combout\ = (SALDO_CLIENTE(1) & ((\VALOR~combout\(1) & (\Add0~1\ & VCC)) # (!\VALOR~combout\(1) & (!\Add0~1\)))) # (!SALDO_CLIENTE(1) & ((\VALOR~combout\(1) & (!\Add0~1\)) # (!\VALOR~combout\(1) & ((\Add0~1\) # (GND)))))
-- \Add0~3\ = CARRY((SALDO_CLIENTE(1) & (!\VALOR~combout\(1) & !\Add0~1\)) # (!SALDO_CLIENTE(1) & ((!\Add0~1\) # (!\VALOR~combout\(1)))))
...
-- Equation(s):
-- \Add0~4_combout\ = ((\VALOR~combout\(2) $ (SALDO_CLIENTE(2) $ (!\Add0~3\)))) # (GND)
-- \Add0~5\ = CARRY((\VALOR~combout\(2) & ((SALDO_CLIENTE(2)) # (!\Add0~3\))) # (!\VALOR~combout\(2) & (SALDO_CLIENTE(2) & !\Add0~3\)))
...
-- Equation(s):
-- RESULT_SUM(2) = (GLOBAL(\Selector1~0clkctrl_outclk\) & ((\Add0~4_combout\))) # (!GLOBAL(\Selector1~0clkctrl_outclk\) & (RESULT_SUM(2)))
...
-- pragma translate_on
PORT MAP (
	dataa => \Selector5~0clkctrl_outclk\,
	datab => S7(2),
	datad => \Selector52~0_combout\,
	combout => S7(2));
...
-- Equation(s):
-- \Mux5~2_combout\ = (\Mux4~1_combout\ & ((\Mux4~2_combout\ & ((\Mux5~1_combout\))) # (!\Mux4~2_combout\ & (S1(2))))) # (!\Mux4~1_combout\ & (((\Mux4~2_combout\))))
...
-- Equation(s):
-- \Add1~9_combout\ = (\VALOR~combout\(3) & ((SALDO_CLIENTE(3) & (!\Add1~7\)) # (!SALDO_CLIENTE(3) & ((\Add1~7\) # (GND))))) # (!\VALOR~combout\(3) & ((SALDO_CLIENTE(3) & (\Add1~7\ & VCC)) # (!SALDO_CLIENTE(3) & (!\Add1~7\))))
-- \Add1~10\ = CARRY((\VALOR~combout\(3) & ((!\Add1~7\) # (!SALDO_CLIENTE(3)))) # (!\VALOR~combout\(3) & (!SALDO_CLIENTE(3) & !\Add1~7\)))
...
-- Equation(s):
-- RESULT_SUM(3) = (GLOBAL(\Selector1~0clkctrl_outclk\) & (\Add0~6_combout\)) # (!GLOBAL(\Selector1~0clkctrl_outclk\) & ((RESULT_SUM(3))))
...
-- Equation(s):
-- \Add0~8_combout\ = ((SALDO_CLIENTE(4) $ (\VALOR~combout\(4) $ (!\Add0~7\)))) # (GND)
-- \Add0~9\ = CARRY((SALDO_CLIENTE(4) & ((\VALOR~combout\(4)) # (!\Add0~7\))) # (!SALDO_CLIENTE(4) & (\VALOR~combout\(4) & !\Add0~7\)))
...
-- Equation(s):
-- \Add0~12_combout\ = ((\VALOR~combout\(6) $ (SALDO_CLIENTE(6) $ (!\Add0~11\)))) # (GND)
-- \Add0~13\ = CARRY((\VALOR~combout\(6) & ((SALDO_CLIENTE(6)) # (!\Add0~11\))) # (!\VALOR~combout\(6) & (SALDO_CLIENTE(6) & !\Add0~11\)))
...
-- Equation(s):
-- RESULT_SUM(6) = (GLOBAL(\Selector1~0clkctrl_outclk\) & ((\Add0~12_combout\))) # (!GLOBAL(\Selector1~0clkctrl_outclk\) & (RESULT_SUM(6)))
...
-- Equation(s):
-- S3(6) = (GLOBAL(\Selector41~0clkctrl_outclk\) & ((\Selector56~0_combout\))) # (!GLOBAL(\Selector41~0clkctrl_outclk\) & (S3(6)))
...
-- Equation(s):
-- \Mux1~0_combout\ = (\ID~combout\(0) & (((\ID~combout\(1)) # (S5(6))))) # (!\ID~combout\(0) & (S4(6) & (!\ID~combout\(1))))
...
-- pragma translate_on
PORT MAP (
	datab => \Selector59~0clkctrl_outclk\,
	datac => S1(6),
	datad => \Selector56~0_combout\,
	combout => S1(6));
...
-- Equation(s):
-- \Mux1~2_combout\ = (\Mux4~2_combout\ & (((\Mux1~1_combout\)) # (!\Mux4~1_combout\))) # (!\Mux4~2_combout\ & (\Mux4~1_combout\ & ((S1(6)))))
...
-- Equation(s):
-- RESULT_SUM(7) = (GLOBAL(\Selector1~0clkctrl_outclk\) & (\Add0~14_combout\)) # (!GLOBAL(\Selector1~0clkctrl_outclk\) & ((RESULT_SUM(7))))
...
-- Equation(s):
-- RESULT_SUM(5) = (GLOBAL(\Selector1~0clkctrl_outclk\) & ((\Add0~10_combout\))) # (!GLOBAL(\Selector1~0clkctrl_outclk\) & (RESULT_SUM(5)))
...
-- Equation(s):
-- S3(5) = (GLOBAL(\Selector41~0clkctrl_outclk\) & (\Selector55~0_combout\)) # (!GLOBAL(\Selector41~0clkctrl_outclk\) & ((S3(5))))
...
-- Equation(s):
-- \Mux2~0_combout\ = (\ID~combout\(0) & (\ID~combout\(1))) # (!\ID~combout\(0) & ((\ID~combout\(1) & (S6(5))) # (!\ID~combout\(1) & ((S4(5))))))
...
-- Equation(s):
-- RESULT_SUM(4) = (GLOBAL(\Selector1~0clkctrl_outclk\) & ((\Add0~8_combout\))) # (!GLOBAL(\Selector1~0clkctrl_outclk\) & (RESULT_SUM(4)))
...
-- Equation(s):
-- \Add1~12_combout\ = ((\VALOR~combout\(4) $ (SALDO_CLIENTE(4) $ (\Add1~10\)))) # (GND)
-- \Add1~13\ = CARRY((\VALOR~combout\(4) & (SALDO_CLIENTE(4) & !\Add1~10\)) # (!\VALOR~combout\(4) & ((SALDO_CLIENTE(4)) # (!\Add1~10\))))
...
-- Equation(s):
-- \Mux3~0_combout\ = (\ID~combout\(0) & ((\ID~combout\(1)) # ((S5(4))))) # (!\ID~combout\(0) & (!\ID~combout\(1) & ((S4(4)))))
...
-- Equation(s):
-- \Mux3~2_combout\ = (\Mux4~2_combout\ & (((\Mux3~1_combout\) # (!\Mux4~1_combout\)))) # (!\Mux4~2_combout\ & (S1(4) & (\Mux4~1_combout\)))
...
-- Equation(s):
-- \Mux0~0_combout\ = (\ID~combout\(1) & ((\ID~combout\(0)) # ((S6(7))))) # (!\ID~combout\(1) & (!\ID~combout\(0) & ((S4(7)))))
...
-- Equation(s):
-- \Mux0~2_combout\ = (\Mux4~1_combout\ & ((\Mux4~2_combout\ & ((\Mux0~1_combout\))) # (!\Mux4~2_combout\ & (S1(7))))) # (!\Mux4~1_combout\ & (((\Mux4~2_combout\))))
...
-- Equation(s):
-- RESULT_SUM(1) = (GLOBAL(\Selector1~0clkctrl_outclk\) & ((\Add0~2_combout\))) # (!GLOBAL(\Selector1~0clkctrl_outclk\) & (RESULT_SUM(1)))
...
-- Equation(s):
-- DADO1(1) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((SALDO_CLIENTE(1)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DADO1(1)))
...
PORT MAP (
	datab => DADO1(1),
	datac => \ESTADO_ATUAL.OPC~clkctrl_outclk\,
...
-- Equation(s):
-- DADO1(2) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((SALDO_CLIENTE(2)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DADO1(2)))
...
-- Equation(s):
-- DADO1(3) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((SALDO_CLIENTE(3)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DADO1(3)))
...
-- Equation(s):
-- \Mux14~0_combout\ = (DADO1(0) & ((DADO1(3)) # (DADO1(1) $ (DADO1(2))))) # (!DADO1(0) & ((DADO1(1)) # (DADO1(2) $ (DADO1(3)))))
...
-- Equation(s):
-- DISPLAY_VECTOR1(0) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((!\Mux14~0_combout\))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DISPLAY_VECTOR1(0)))
...
-- Equation(s):
-- \A1$latch~combout\ = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((DISPLAY_VECTOR1(0)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (\A1$latch~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \A1$latch~combout\,
	datac => DISPLAY_VECTOR1(0),
	datad => \ESTADO_ATUAL.OPC~clkctrl_outclk\,
	combout => \A1$latch~combout\);

-- Location: LCCOMB_X31_Y1_N10
\Mux13~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \Mux13~0_combout\ = (DADO1(0) & (DADO1(3) $ (((DADO1(1)) # (!DADO1(2)))))) # (!DADO1(0) & (DADO1(1) & (!DADO1(2) & !DADO1(3))))
...
-- Equation(s):
-- DISPLAY_VECTOR1(1) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((\Mux13~0_combout\))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DISPLAY_VECTOR1(1)))
...
-- Equation(s):
-- \B1$latch~combout\ = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((DISPLAY_VECTOR1(1)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (\B1$latch~combout\))
...
-- Equation(s):
-- \Mux12~0_combout\ = (DADO1(1) & (DADO1(0) & ((!DADO1(3))))) # (!DADO1(1) & ((DADO1(2) & ((!DADO1(3)))) # (!DADO1(2) & (DADO1(0)))))
...
-- Equation(s):
-- DISPLAY_VECTOR1(2) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((\Mux12~0_combout\))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DISPLAY_VECTOR1(2)))
...
-- Equation(s):
-- \C1$latch~combout\ = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((DISPLAY_VECTOR1(2)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (\C1$latch~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \C1$latch~combout\,
	datac => DISPLAY_VECTOR1(2),
	datad => \ESTADO_ATUAL.OPC~clkctrl_outclk\,
...
-- Equation(s):
-- \Mux11~0_combout\ = (DADO1(1) & ((DADO1(0) & (DADO1(2))) # (!DADO1(0) & (!DADO1(2) & DADO1(3))))) # (!DADO1(1) & (!DADO1(3) & (DADO1(0) $ (DADO1(2)))))
...
-- Equation(s):
-- DISPLAY_VECTOR1(3) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((\Mux11~0_combout\))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DISPLAY_VECTOR1(3)))
...
-- Equation(s):
-- \D1$latch~combout\ = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((DISPLAY_VECTOR1(3)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (\D1$latch~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \D1$latch~combout\,
	datac => \ESTADO_ATUAL.OPC~clkctrl_outclk\,
	datad => DISPLAY_VECTOR1(3),
	combout => \D1$latch~combout\);

-- Location: LCCOMB_X31_Y1_N28
\Mux10~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \Mux10~0_combout\ = (DADO1(2) & (DADO1(3) & ((DADO1(1)) # (!DADO1(0))))) # (!DADO1(2) & (!DADO1(0) & (DADO1(1) & !DADO1(3))))
...
-- Equation(s):
-- DISPLAY_VECTOR1(4) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((\Mux10~0_combout\))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DISPLAY_VECTOR1(4)))
...
-- Equation(s):
-- \E1$latch~combout\ = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((DISPLAY_VECTOR1(4)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (\E1$latch~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \E1$latch~combout\,
	datac => \ESTADO_ATUAL.OPC~clkctrl_outclk\,
	datad => DISPLAY_VECTOR1(4),
	combout => \E1$latch~combout\);

-- Location: LCCOMB_X31_Y1_N20
\DADO1[0]\ : cycloneii_lcell_comb
-- Equation(s):
-- DADO1(0) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((SALDO_CLIENTE(0)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DADO1(0)))
...
-- Equation(s):
-- DISPLAY_VECTOR1(5) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((\Mux9~0_combout\))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DISPLAY_VECTOR1(5)))
...
-- Equation(s):
-- \F1$latch~combout\ = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((DISPLAY_VECTOR1(5)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (\F1$latch~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \F1$latch~combout\,
	datac => DISPLAY_VECTOR1(5),
	datad => \ESTADO_ATUAL.OPC~clkctrl_outclk\,
...
-- Equation(s):
-- \Mux8~0_combout\ = (DADO1(2) & (!DADO1(1) & (DADO1(0) $ (!DADO1(3))))) # (!DADO1(2) & (DADO1(0) & (DADO1(1) $ (!DADO1(3)))))
...
-- Equation(s):
-- DISPLAY_VECTOR1(6) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((\Mux8~0_combout\))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DISPLAY_VECTOR1(6)))
...
-- Equation(s):
-- \G1$latch~combout\ = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((DISPLAY_VECTOR1(6)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (\G1$latch~combout\))
...
PORT MAP (
	...
	datac => \ESTADO_ATUAL.OPC~clkctrl_outclk\,
	datad => DISPLAY_VECTOR1(6),
	combout => \G1$latch~combout\);

-- Location: LCCOMB_X59_Y4_N14
\DADO2[1]\ : cycloneii_lcell_comb
-- Equation(s):
-- DADO2(1) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((SALDO_CLIENTE(5)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DADO2(1)))
...
-- Equation(s):
-- DADO2(0) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((SALDO_CLIENTE(4)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DADO2(0)))
...
-- Equation(s):
-- DADO2(3) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((SALDO_CLIENTE(7)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DADO2(3)))
...
-- Equation(s):
-- \Mux21~0_combout\ = (DADO2(0) & ((DADO2(3)) # (DADO2(2) $ (DADO2(1))))) # (!DADO2(0) & ((DADO2(1)) # (DADO2(2) $ (DADO2(3)))))
...
-- Equation(s):
-- DISPLAY_VECTOR2(0) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((!\Mux21~0_combout\))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DISPLAY_VECTOR2(0)))
...
-- Equation(s):
-- \A2$latch~combout\ = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DISPLAY_VECTOR2(0))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((\A2$latch~combout\)))
...
-- Equation(s):
-- \Mux20~0_combout\ = (DADO2(2) & (DADO2(0) & (DADO2(1) $ (DADO2(3))))) # (!DADO2(2) & (!DADO2(3) & ((DADO2(1)) # (DADO2(0)))))
...
-- Equation(s):
-- DISPLAY_VECTOR2(1) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((\Mux20~0_combout\))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DISPLAY_VECTOR2(1)))
...
-- Equation(s):
-- \B2$latch~combout\ = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((DISPLAY_VECTOR2(1)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (\B2$latch~combout\))
...
-- Equation(s):
-- DISPLAY_VECTOR2(2) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((\Mux19~0_combout\))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DISPLAY_VECTOR2(2)))
...
-- Equation(s):
-- \C2$latch~combout\ = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((DISPLAY_VECTOR2(2)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (\C2$latch~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \C2$latch~combout\,
	datac => DISPLAY_VECTOR2(2),
	datad => \ESTADO_ATUAL.OPC~clkctrl_outclk\,
...
-- Equation(s):
-- DISPLAY_VECTOR2(3) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((\Mux18~0_combout\))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DISPLAY_VECTOR2(3)))
...
-- Equation(s):
-- \D2$latch~combout\ = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((DISPLAY_VECTOR2(3)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (\D2$latch~combout\))
...
-- Equation(s):
-- DADO2(2) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((SALDO_CLIENTE(6)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DADO2(2)))
...
-- Equation(s):
-- \Mux17~0_combout\ = (DADO2(2) & (DADO2(3) & ((DADO2(1)) # (!DADO2(0))))) # (!DADO2(2) & (!DADO2(0) & (DADO2(1) & !DADO2(3))))
...
-- Equation(s):
-- DISPLAY_VECTOR2(4) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((\Mux17~0_combout\))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DISPLAY_VECTOR2(4)))
...
-- Equation(s):
-- \E2$latch~combout\ = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((DISPLAY_VECTOR2(4)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (\E2$latch~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \E2$latch~combout\,
	datac => \ESTADO_ATUAL.OPC~clkctrl_outclk\,
	datad => DISPLAY_VECTOR2(4),
	combout => \E2$latch~combout\);

-- Location: LCCOMB_X58_Y4_N28
\Mux16~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \Mux16~0_combout\ = (DADO2(1) & ((DADO2(0) & ((DADO2(3)))) # (!DADO2(0) & (DADO2(2))))) # (!DADO2(1) & (DADO2(2) & (DADO2(3) $ (DADO2(0)))))
...
-- Equation(s):
-- DISPLAY_VECTOR2(5) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((\Mux16~0_combout\))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DISPLAY_VECTOR2(5)))
...
-- Equation(s):
-- \F2$latch~combout\ = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((DISPLAY_VECTOR2(5)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (\F2$latch~combout\))
...
-- Equation(s):
-- DISPLAY_VECTOR2(6) = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((\Mux15~0_combout\))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (DISPLAY_VECTOR2(6)))
...
-- Equation(s):
-- \G2$latch~combout\ = (GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & ((DISPLAY_VECTOR2(6)))) # (!GLOBAL(\ESTADO_ATUAL.OPC~clkctrl_outclk\) & (\G2$latch~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \G2$latch~combout\,
	datac => DISPLAY_VECTOR2(6),
	datad => \ESTADO_ATUAL.OPC~clkctrl_outclk\,
